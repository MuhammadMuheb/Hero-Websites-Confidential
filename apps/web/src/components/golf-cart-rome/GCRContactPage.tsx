...
/**
 * Contact page — mirrors Rome Vespa's/Private Vatican's Contact page
...
const CONTACT_CHANNELS = [
  {
    ...
    detail: "Which tour fits your group's mobility needs, party size, or budget — ask before you book.",
    icon: (
      <>
  ...
  },
  {
    ...
    detail: 'Wrong price, changed accessibility policy, or a broken link — flag it and we fix it fast.',
    icon: (
      <>
  ...
  },
  {
    ...
    detail: 'Tour operators, accessibility organizations, and journalists — reach out here.',
    icon: (
      <>
...
function mailtoWithSubject(subject: string) {
  return `mailto:hello@golfcartrome.com?subject=${encodeURIComponent(subject)}`;
}
    ...
    <div className="gcr-scope bg-white">
        ...
        <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-10 px-6 py-10 sm:px-14 sm:py-14 lg:grid-cols-2 lg:gap-14">
          <div>
            ...
            <p className="mt-5 max-w-[52ch] text-[16px] leading-relaxed text-ink-muted">
              Spotted something out of date, unsure which tour fits your group&rsquo;s needs, or have a partnership
              question? Email us directly — there&rsquo;s no ticket queue and no auto-reply between you and an
              answer.
            </p>

            <a
              href="mailto:hello@golfcartrome.com"
      ...
      <section className="border-b border-line py-14 sm:py-16">
        <div className="mx-auto max-w-[760px] px-6 sm:px-14">
          ...
          <h2 className="mt-2 font-sans text-[26px] font-extrabold leading-snug tracking-tight text-ink sm:text-[32px]">
            Not Affiliated with Any Single Cart Operator
          </h2>
          <p className="mt-4 text-base leading-relaxed text-ink-muted">
            Golf Cart Rome is an independent publication. We have no affiliation with, and are not endorsed or
            sponsored by, any cart operator, tour company, or vehicle manufacturer. Every comparison and
      ...
      <section id="disclosure" className="scroll-mt-[85px] border-b border-line py-14 sm:py-16">
        <div className="mx-auto max-w-[760px] px-6 sm:px-14">
          ...
          <div className="mt-8 rounded-media border border-line bg-paper-tint p-6 sm:p-8">
            ...
            <p className="mt-4 text-base leading-relaxed text-ink-muted">
              Golf Cart Rome participates in affiliate programs with the two partners above. When you book a tour
