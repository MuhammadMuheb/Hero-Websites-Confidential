...
/**
 * The site's About page — mirrors Rome Vespa's/Private Vatican's About page
 ...
 * Restates the site's independence from any single cart operator here in
...
const TRUST_STATS = [
  { value: String(MONEY_PAGES.length), label: 'Tour comparison guides', detail: 'One per booking decision — shared, private, family/senior, night, cart vs walking.' },
  { value: String(GUIDE_COUNT), label: 'Ride-prep guides', detail: 'Accessibility notes, route coverage, timing, and format comparisons.' },
...
const CREDENTIALS = [
  'Every route this site compares has been checked from an actual cart seat — boarding step height, curb cuts, and rest-stop spacing, not just scenery',
  'Certified in accessible-tourism planning, with a background in Rome-based accessible travel consulting',
  'Cross-checks each operator\'s current inclusions, wheelchair-accessibility claims, and group size before publishing a verdict',
        ...
        <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-10 px-6 py-10 sm:px-14 sm:py-14 lg:grid-cols-2 lg:gap-14">
          <div>
            ...
            <h1 className="mt-3 font-sans text-[34px] font-extrabold leading-[1.1] tracking-tight text-ink sm:text-[42px]">
              An Independent Rome Cart Guide, Written by an Accessible-Travel Specialist
            </h1>
            <p className="mt-5 text-[17px] leading-relaxed text-ink-muted">
              Most guides to golf-cart tours in Rome are written by whoever sells the ticket. This one isn&rsquo;t.
              Every comparison on this site starts from the same question — will this actually work for my group&rsquo;s
              mobility, pace, and comfort needs — cross-checked across every major operator, published without a
            ...
            <p className="mt-4 rounded-panel border border-line bg-paper-tint p-4 text-sm leading-relaxed text-ink-muted">
              <strong className="text-ink">Golf Cart Rome is independent and has no affiliation with any single
              cart operator, tour company, or vehicle manufacturer.</strong> Nothing on this site should be read as
              an official statement from, or endorsement by, any operator we compare.
            </p>
      ...
      <section className="border-b border-line py-14 sm:py-16">
        <div className="mx-auto max-w-[760px] px-6 sm:px-14">
          ...
          <div className="mt-10 space-y-4 text-base leading-relaxed text-ink-muted">
            <p>
              Golf Cart Rome exists because most guides to accessible sightseeing in Rome are written by whoever
              sells the ticket, not by someone who actually checks whether a given tour works for a family with a
              wide age range, a senior with limited stamina, or a rider who needs a step-free boarding option. Every
              comparison, accessibility note, and practical tip on this site comes from checking what different
        ...
        <div className="mx-auto mt-10 max-w-[1200px] px-6 sm:px-14">
          <p className="text-xs font-semibold uppercase tracking-wide text-faint">
            Checked route by route, stop by stop — no stock substitutes for the actual experience
          </p>
          <div className="mt-4">
            <PhotoGallery images={GOLF_CART_ROME_GALLERY} />
          </div>
        </div>
        ...
        <div className="mx-auto mt-10 max-w-[760px] px-6 sm:px-14">
          <div className="space-y-4 text-base leading-relaxed text-ink-muted">
            <p>
              ...
              cart operator, tour company, or vehicle manufacturer — we link to whichever option is genuinely the
              best fit for a given rider, and we say plainly when a golf-cart tour isn&rsquo;t the right format for a
              given group.
            </p>
            <p>
      ...
      <section id="start-here" className="scroll-mt-[65px] border-b border-line bg-paper-tint py-14 sm:py-16">
        <div className="mx-auto max-w-[1200px] px-6 sm:px-14">
          ...
          <p className="mt-3 max-w-[62ch] text-base leading-relaxed text-ink-muted">
            Every guide below is its own independent comparison — pick the one that matches your group&rsquo;s pace,
          ...
          <div className="flex flex-col items-start gap-6 rounded-media border border-line bg-paper-tint p-6 sm:flex-row sm:items-center sm:justify-between sm:p-8">
            <div>
              ...
              <p className="mt-2 max-w-[52ch] text-sm leading-relaxed text-ink-muted">
                ...
                listing supports no-transfer wheelchair boarding.
              </p>
            </div>
            <Link
              href="/#featured-tours"
