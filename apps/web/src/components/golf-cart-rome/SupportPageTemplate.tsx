...
/**
 * Shared template for all 5 Golf Cart Rome support pages — mirrors Rome
 * Vespa's/Private Vatican's SupportPageTemplate.tsx exactly in structure
 ...
 * data-driven (lib/golf-cart-rome-content.ts).
 */
