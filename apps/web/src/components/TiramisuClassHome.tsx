...
/**
 * Homepage for the Tiramisù Class hero property (tiramisuclass.com, served
        ...
        <div className="flex flex-wrap items-end justify-between gap-y-4">
          <div>
            ...
            <h2 className="mt-2 font-display text-[26px] font-bold leading-[1.2] tracking-tight text-ink sm:text-[32px]">
              Choose Your Rome Tiramisù Class
            </h2>
          </div>
    ...
    <section id="featured-tours" className="scroll-mt-[65px] border-b border-line bg-paper-tint py-16 sm:py-20">
      <div className="mx-auto max-w-[1200px] px-6 sm:px-14">
        ...
        <p className="mt-2 flex items-center gap-1.5 text-sm font-semibold text-gold">
          ...
          Private and celebration-friendly slots book out first — reserve at least a few days ahead in peak season.
        </p>
...
export function TiramisuClassHome() {
  const websiteJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'WebSite',
    name: 'Tiramisù Class',
    url: 'https://tiramisuclass.com/',
  };
  ...
  const itemListJsonLd = {
    ...
    itemListElement: MONEY_PAGES.map((page, index) => ({
      ...
      position: index + 1,
      name: page.title,
      url: `https://tiramisuclass.com${page.href}`,
    })),
  };
  ...
  const courseJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Course',
    name: 'Rome Tiramisù Classes',
    description:
      'Independent guide to hands-on tiramisù and dessert classes in Rome — mascarpone technique, coffee-soak timing, and couples, private, and combo class options compared.',
    provider: { '@type': 'Organization', name: 'Tiramisù Class' },
    url: 'https://tiramisuclass.com/',
  };
  ...
  return (
    <div className="tc-scope bg-white">
        ...
        <div className="mx-auto grid max-w-[1200px] gap-10 px-6 py-14 sm:px-14 lg:grid-cols-[1.05fr_1fr] lg:items-center lg:py-20">
          <div>
            ...
            <h1 className="mt-4 font-display text-[34px] font-bold leading-[1.12] tracking-tight text-ink sm:text-[48px]">
              Make Real Tiramisù, Layer by Layer
            </h1>
            <p className="mt-5 max-w-[52ch] text-[17px] leading-relaxed text-ink-muted">
              A single-dish class built entirely around getting the mascarpone, the coffee-soak, and the layering
              technique right — no rushed multi-dish itinerary.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-2.5 text-sm text-ink-muted sm:flex-row sm:flex-wrap sm:gap-x-6 sm:gap-y-2">
              {[
                'Single-dish focus, done properly',
                'Couples and gift-experience formats available',
                'Pairs cleanly with a food tour on the same trip',
      ...
      {/* ---------- before you book: tiramisu facts ---------- */}
      <section className="border-b border-line bg-paper-tint py-14 sm:py-16">
        <div className="mx-auto max-w-[1200px] px-6 sm:px-14">
          ...
          <h2 className="mt-2 font-display text-[24px] font-bold leading-snug tracking-tight text-ink sm:text-[28px]">
            Tiramisù, by the Numbers
          </h2>
          <p className="mt-3 max-w-[62ch] text-[15.5px] leading-relaxed text-ink-muted">
            A little history and technique before you book — the dish and the craft behind every class.
          </p>
          <div className="mt-8">
      ...
      <section className="border-b border-line py-16 sm:py-20">
        <div className="mx-auto max-w-[1200px] px-6 sm:px-14">
          ...
          <p className="mt-3 max-w-[62ch] text-[15.5px] leading-relaxed text-ink-muted">
            ...
            you taste a chilled sample in class or take your tiramisù home to set, and price.
          </p>
          <div className="mt-8">
            <TourComparisonTable tours={FEATURED_TOURS} caption="Comparison of every featured Tiramisù Class listing by partner, duration, tasting format and price" />
          </div>
        </div>
      </section>

      {/* ---------- before you book / support pages ---------- */}
      <section id="dessert-prep" className="scroll-mt-[65px] border-b border-line bg-paper-tint py-16 sm:py-20">
        <div className="mx-auto max-w-[1200px] px-6 sm:px-14">
