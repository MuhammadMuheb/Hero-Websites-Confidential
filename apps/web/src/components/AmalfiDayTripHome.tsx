...
import { HERO } from '@/lib/amalfi-day-trip-content';
import {
  CarouselArrows,
  QuickFactsStrip,
  RibbonBadge,
...
/**
 * Homepage for the Amalfi Day Trip hero property (amalfidaytrip.com,
...
export function AmalfiDayTripHome() {
  const websiteJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'WebSite',
    name: 'Amalfi Day Trip',
    url: 'https://amalfidaytrip.com/',
  };
  ...
  const itemListJsonLd = {
    ...
    itemListElement: MONEY_PAGES.map((page, index) => ({
      ...
      position: index + 1,
      name: page.title,
      url: `https://amalfidaytrip.com${page.href}`,
    })),
  };
  ...
  const touristTripJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'TouristTrip',
    name: 'Amalfi Coast Day Trips',
    description:
      'Independent guide to Amalfi Coast day trips by road and boat — Positano, Ravello, and Amalfi routing with honest boat-vs-road comparisons.',
    provider: { '@type': 'Organization', name: 'Amalfi Day Trip' },
    url: 'https://amalfidaytrip.com/',
  };
  ...
  return (
    <div className="adt-scope bg-white">
      ...
      <NetworkPropertyHero
        ...
        searchPlaceholder="Search Amalfi trips…"
      />

      {/* ---------- before you book: amalfi facts ---------- */}
      ...
      <section className="border-b border-line py-16 sm:py-20">
        <div className="mx-auto max-w-[1200px] px-6 sm:px-14">
          ...
          <h2 className="mt-2 font-display text-[26px] font-bold leading-[1.2] tracking-tight text-ink sm:text-[32px]">
            Compare All Amalfi Day Trips at a Glance
          </h2>
          <p className="mt-3 max-w-[62ch] text-[15.5px] leading-relaxed text-ink-muted">
          ...
          <div className="mt-8">
            <TourComparisonTable tours={FEATURED_TOURS} caption="Comparison of every featured Amalfi Day Trip listing by partner, duration, boat-tour option and price" />
          </div>
        </div>
      </section>
