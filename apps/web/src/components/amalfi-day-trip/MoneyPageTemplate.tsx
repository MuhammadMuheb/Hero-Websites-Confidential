...
import { AtAGlanceBox, TourComparisonTable, ADTAuthorBox, ADTFooter } from './ADTShared';
...
export function MoneyPageTemplate({ content }: { content: MoneyPageContent }) {
  ...
  const touristTripJsonLd = {
    ...
    url: `https://amalfidaytrip.com${content.href}`,
  ...
  const productJsonLd = relevantTours.map((tour) => ({
    ...
    offers: {
      ...
      url: `https://amalfidaytrip.com/go/${tour.slug}`,
