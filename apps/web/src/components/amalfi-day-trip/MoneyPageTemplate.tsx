...
import { AtAGlanceBox, TourComparisonTable, ADTAuthorBox, ADTFooter, ADTHeader } from './ADTShared';
import { getFeaturedToursForPage } from '@/lib/amalfi-day-trip';
import type { MoneyPageContent } from '@/lib/amalfi-day-trip-content';

/**
 * Shared template for all 4 Amalfi Day Trip money pages — mirrors
 ...
 * cards, a verdict block, FAQ, one contextual link). The `.ADT-scope`
...
export function MoneyPageTemplate({ content }: { content: MoneyPageContent }) {
  ...
  return (
    <div className="ADT-scope bg-white pb-20 lg:pb-0">
      ...
      <ADTHeader toursHref="/#tours" planHref="/#plan-your-trip" faqHref="#faq" ctaHref="#trip-options" />
