    ...
    <section id="featured-tours" className="scroll-mt-[65px] border-b border-line bg-paper-tint py-16 sm:py-20">
      <div className="mx-auto max-w-[1200px] px-6 sm:px-14">
        ...
        <p className="mt-2 flex items-center gap-1.5 text-sm font-semibold text-gold">
          ...
          Early-access slots are capped daily — official releases can sell out weeks ahead.
        </p>
...
export function PrivateVaticanHome() {
  const websiteJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'WebSite',
    name: 'Private Vatican',
    url: 'https://privatevatican.com/',
  };
  ...
  const itemListJsonLd = {
    ...
    itemListElement: MONEY_PAGES.map((page, index) => ({
      ...
      position: index + 1,
      name: page.title,
      url: `https://privatevatican.com${page.href}`,
    })),
  };
  ...
  const attractionJsonLd = {
    ...
    description:
      'Independent guide to Vatican early-access and private tours — not affiliated with the Vatican Museums.',
    url: 'https://privatevatican.com/',
  };
  ...
  return (
    <div className="pv-scope bg-white">
      ...
      <section className="border-b border-line">
        <div className="mx-auto grid max-w-[1200px] gap-10 px-6 py-14 sm:px-14 lg:grid-cols-[1.05fr_1fr] lg:items-center lg:py-20">
          <div>
            ...
            <h1 className="mt-4 font-display text-[38px] font-bold leading-[1.08] tracking-tight text-ink sm:text-[54px]">
              Vatican Early-Access &amp; Private Tours, Before the Crowds Arrive
            </h1>
            <p className="mt-5 max-w-[52ch] text-[17px] leading-relaxed text-ink-muted">
              Independent, first-hand guidance on early-entry Sistine Chapel access, private guides, and what
              actually happens before the museums open to the general public. Not affiliated with the Vatican
              Museums.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-2.5 text-sm text-ink-muted sm:flex-row sm:flex-wrap sm:gap-x-6 sm:gap-y-2">
              {[
                'Independent — not affiliated with the Vatican Museums',
                'Every tour taken in person before recommending it',
                'Dress code and security rules explained plainly',
                'Compares GetYourGuide · Viator · Tiqets',
              ].map((label) => (
      ...
      {/* ---------- the Vatican by the numbers ---------- */}
      <section className="border-b border-line bg-paper-tint py-14 sm:py-16">
        <div className="mx-auto max-w-[1200px] px-6 sm:px-14">
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-accent">Before it was a museum</p>
          <h2 className="mt-2 font-display text-[26px] font-bold leading-snug tracking-tight text-ink sm:text-[32px]">
            The Vatican, by the Numbers
          </h2>
          <p className="mt-3 max-w-[62ch] text-[15.5px] leading-relaxed text-ink-muted">
            A little history before you book — the same facts that make an early-access slot worth the extra cost in
            the first place.
          </p>
          <div className="mt-8">
      ...
      <section className="border-b border-line py-16 sm:py-20">
        <div className="mx-auto max-w-[1200px] px-6 sm:px-14">
          ...
          <p className="mt-3 max-w-[62ch] text-[15.5px] leading-relaxed text-ink-muted">
            ...
            early access before public opening is actually included, and price.
          </p>
          <div className="mt-8">
            <TourComparisonTable tours={FEATURED_TOURS} caption="Comparison of every featured Vatican tour by partner, duration, early access and price" />
          </div>
        </div>
      </section>
