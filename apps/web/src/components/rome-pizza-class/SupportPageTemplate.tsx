...
/**
 * Shared template for all 4 Rome Pizza Class support pages — mirrors Golf
 * Cart Rome's/Cooking in Rome's SupportPageTemplate.tsx exactly in structure
 ...
 * data-driven (lib/rome-pizza-class-content.ts).
 */
