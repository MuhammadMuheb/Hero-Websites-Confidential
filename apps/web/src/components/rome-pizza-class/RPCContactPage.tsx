...
/**
 * Contact page — mirrors Golf Cart Rome's/Cooking in Rome's Contact page
 * structure exactly: a mailto contact method (no submission form — there's
 * no backend to receive one, so an honest mailto beats a form that silently
 * goes nowhere), a routed-by-topic contact grid, a response-time trust
 * strip, and a restyled affiliate-disclosure card.
 */

const CONTACT_CHANNELS = [
  {
    subject: 'Question about a class',
    label: 'General Questions',
    detail: 'Which class fits your group, oven-type preference, or budget — ask before you book.',
    icon: (
      <>
  ...
  },
  {
    ...
    detail: 'Wrong price, changed oven type, or a broken link — flag it and we fix it fast.',
    icon: (
      <>
  ...
  },
  {
    ...
    detail: 'Cooking schools, pizzerias, and journalists — reach out here.',
    icon: (
      <>
...
const RESPONSE_STATS = [
  ...
  { value: '2', label: 'Partners fully disclosed', detail: 'GetYourGuide and Viator — named, not buried in fine print.' },
];

function mailtoWithSubject(subject: string) {
  return `mailto:hello@romepizzaclass.com?subject=${encodeURIComponent(subject)}`;
}
    ...
    <div className="rpc-scope bg-white">
        ...
        <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-10 px-6 py-10 sm:px-14 sm:py-14 lg:grid-cols-2 lg:gap-14">
          <div>
            ...
            <p className="mt-5 max-w-[52ch] text-[16px] leading-relaxed text-ink-muted">
              Spotted something out of date, unsure which class fits your group, or have a partnership question?
              Email us directly &mdash; there&rsquo;s no ticket queue and no auto-reply between you and an answer.
            </p>

            <a
              href="mailto:hello@romepizzaclass.com"
          ...
          <div className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-3">
            {CONTACT_CHANNELS.map((channel) => (
              ...
              >
                ...
                <h3 className="mt-4 font-sans text-[16px] font-extrabold leading-snug text-ink">{channel.label}</h3>
        ...
        <div className="mx-auto max-w-[760px] px-6 sm:px-14">
          <div className="rounded-media border border-line bg-white p-6 sm:p-8">
            ...
            <p className="mt-4 text-base leading-relaxed text-ink-muted">
              ...
              this site works &mdash; it&rsquo;s one person, and a direct email is the honest version of that. A
              form that quietly went nowhere would be worse than no form at all, so we didn&rsquo;t build one.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-line py-14 sm:py-16">
        <div className="mx-auto max-w-[760px] px-6 sm:px-14">
          ...
          <h2 className="mt-2 font-sans text-[26px] font-extrabold leading-snug tracking-tight text-ink sm:text-[32px]">
            Not Affiliated with Any Single Pizzeria or Cooking School
          </h2>
          <p className="mt-4 text-base leading-relaxed text-ink-muted">
            Rome Pizza Class is an independent publication. We have no affiliation with, and are not endorsed or
            sponsored by, any pizzeria, cooking school, GetYourGuide, or Viator. Every comparison and recommendation
            on this site reflects our own research, not an official position of any of those organizations.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[760px] px-6 sm:px-14">
          ...
          <div className="mt-8 rounded-media border border-line bg-paper-tint p-6 sm:p-8">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {['GetYourGuide', 'Viator'].map((partner) => (
            ...
            <p className="mt-4 text-base leading-relaxed text-ink-muted">
              Rome Pizza Class participates in affiliate programs with the two partners above. When you book a class
              through an outbound link on this site, we may earn a commission at no extra cost to you. This site
              independently compares classes across both platforms and does not accept payment for placement — a
              class appearing higher on a comparison reflects our own editorial judgment, not a sponsorship
              arrangement.
            </p>
          </div>
        </div>
