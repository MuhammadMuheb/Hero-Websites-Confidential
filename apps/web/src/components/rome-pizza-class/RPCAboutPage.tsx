...
/**
 * The site's About page — mirrors Golf Cart Rome's/Cooking in Rome's About
 * page structure exactly (author bio/credentials, a stat grid backing up the
 * independence claim, a photo grid, a card grid into the money pages).
 * Restates the site's independence from any single pizzeria or cooking
 * school here in full, matching the network's non-affiliation disclosure
 * convention.
 */
...
const TRUST_STATS = [
  { value: String(MONEY_PAGES.length), label: 'Class comparison guides', detail: 'One per booking decision — flagship, combo, family, and private.' },
  { value: String(GUIDE_COUNT), label: 'Before-you-book guides', detail: 'Inclusions, age limits, format comparisons, and wine-pairing notes.' },
  { value: '2', label: 'Partners cross-checked', detail: 'GetYourGuide and Viator — compared, never favored.' },
  { value: '0', label: 'Sponsored placements', detail: 'No operator pays for a better spot in any comparison.' },
];

const CREDENTIALS = [
  'Every class this site compares has been taken in person — dough hydration, proving time, and oven type checked directly, not from marketing photos',
  'Trained as a pizzaiolo in Rome, with hands-on experience running wood-fired ovens at commercial temperature',
  "Cross-checks each operator's current oven type, topping list, and group-size cap before publishing a verdict",
  'Publishes "book a different format instead" as often as "book this" when that\'s the honest answer',
];
        ...
        <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-10 px-6 py-10 sm:px-14 sm:py-14 lg:grid-cols-2 lg:gap-14">
          <div>
            ...
            <h1 className="mt-3 font-sans text-[34px] font-extrabold leading-[1.1] tracking-tight text-ink sm:text-[42px]">
              An Independent Rome Pizza Class Guide, Written by a Working Pizzaiolo
            </h1>
            <p className="mt-5 text-[17px] leading-relaxed text-ink-muted">
              Most guides to pizza-making classes in Rome are written by whoever sells the ticket. This one
              isn&rsquo;t. Every comparison on this site starts from the same question &mdash; does this class
              actually teach real dough technique in a real wood-fired oven &mdash; cross-checked across every major
            ...
            <p className="mt-4 rounded-panel border border-line bg-paper-tint p-4 text-sm leading-relaxed text-ink-muted">
              <strong className="text-ink">Rome Pizza Class is independent and has no affiliation with any single
              pizzeria, cooking school, GetYourGuide, or Viator.</strong> Nothing on this site should be read as an
              official statement from, or endorsement by, any operator we compare.
            </p>
      ...
      <section className="border-b border-line py-14 sm:py-16">
        <div className="mx-auto max-w-[760px] px-6 sm:px-14">
          ...
          <div className="mt-10 space-y-4 text-base leading-relaxed text-ink-muted">
            <p>
              Rome Pizza Class exists because most guides to pizza-making classes are written by whoever sells the
              ticket, not by someone who actually checks whether a given class teaches real dough technique in a
              real wood-fired oven or is mostly a topping-and-eat session dressed up in flame-photo marketing. Every
              comparison, technique note, and practical tip on this site comes from checking what different
              operators (GetYourGuide, Viator) actually provide against each other, rather than repeating marketing
              copy.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto mt-10 max-w-[1200px] px-6 sm:px-14">
          <p className="text-xs font-semibold uppercase tracking-wide text-faint">
            Checked oven by oven, dough ball by dough ball — no stock substitutes for the actual class
          </p>
          <div className="mt-4">
            <PhotoGallery images={ROME_PIZZA_CLASS_GALLERY} />
          </div>
        </div>
        ...
        <div className="mx-auto mt-10 max-w-[760px] px-6 sm:px-14">
          <div className="space-y-4 text-base leading-relaxed text-ink-muted">
            <p>
              ...
              pizzeria, cooking school, GetYourGuide, or Viator &mdash; we link to whichever class is genuinely the
              best fit for a given visitor, and we say plainly when a class&rsquo;s marketing photos don&rsquo;t
              match what actually happens in the kitchen.
            </p>
            <p>
      ...
      <section id="start-here" className="scroll-mt-[65px] border-b border-line bg-paper-tint py-14 sm:py-16">
        <div className="mx-auto max-w-[1200px] px-6 sm:px-14">
          ...
          <p className="mt-3 max-w-[62ch] text-base leading-relaxed text-ink-muted">
            Every guide below is its own independent comparison &mdash; pick the one that matches your group and
          ...
          <div className="flex flex-col items-start gap-6 rounded-media border border-line bg-paper-tint p-6 sm:flex-row sm:items-center sm:justify-between sm:p-8">
            <div>
              ...
              <p className="mt-2 max-w-[52ch] text-sm leading-relaxed text-ink-muted">
                The full comparison table &mdash; GetYourGuide and Viator, ranked by price, duration, and whether the
                class bakes in a genuine wood-fired oven.
              </p>
            </div>
            <Link
              href="/#featured-tours"
