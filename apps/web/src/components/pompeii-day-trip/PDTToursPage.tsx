...
/**
 * Pompeii Day Trip Tours index page — displays featured Pompeii tours in a grid.
 * Mirrors Street Food Rome's Tours index structure. Wrapped in .pdt-scope for
 * Volcanic Ember theming.
 */

export function PDTToursPage() {
  const jsonLd = {
    '@context': 'https://schema.org',
    '@type': 'CollectionPage',
    name: 'Pompeii Day Trips',
    description: 'Featured Pompeii day trips from Rome, Naples, Sorrento, and the Amalfi Coast',
    url: 'https://pompeiidaytrip.com/tours',
    mainEntity: {
      '@type': 'ItemList',
    ...
    <div className="pdt-scope bg-white">
      ...
      <section className="border-b border-line">
        ...
        <div className="mx-auto max-w-[1440px] px-6 py-14 text-center sm:px-14 sm:py-16">
          <h1 className="font-display text-3xl font-semibold text-ink sm:text-4xl">Featured Pompeii Tours</h1>
          <p className="mt-4 text-ink-muted">Curated Pompeii day trips from major departure points</p>
        </div>
      </section>
