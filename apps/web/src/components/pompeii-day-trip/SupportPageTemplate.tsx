...
/**
 * Shared template for all 6 Pompeii Day Trip support pages — mirrors
 * Underground Colosseum's and Private Vatican's SupportPageTemplate.tsx
 * exactly in structure (FAQPage + BreadcrumbList schema, first-hand detail,
 * one primary CTA into the money page it feeds, one contextual link, FAQ).
 * Content is entirely data-driven (lib/pompeii-day-trip-content.ts).
 */
