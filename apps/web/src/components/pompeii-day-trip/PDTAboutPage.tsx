 ...
 * and Private Vatican's PVAboutPage.tsx structure exactly (author bio/
 * credentials, a stat grid backing up the independence claim, a photo grid,
 * a card grid into the money pages).
 */

const GUIDE_COUNT = SUPPORT_PAGES.length;

const TRUST_STATS = [
  { value: String(MONEY_PAGES.length), label: 'Tour comparison guides', detail: 'One per origin city and pairing decision — Rome, Naples, Sorrento/Amalfi, Vesuvius, Herculaneum, private.' },
  { value: String(GUIDE_COUNT), label: 'Planning guides', detail: 'Transit logistics, timing, heat, and the honest verdict.' },
  { value: '3', label: 'Partners cross-checked', detail: 'GetYourGuide, Viator, and Civitatis — compared, never favored.' },
  { value: '0', label: 'Invented visitor stats', detail: 'Only verifiable site facts about Pompeii, Herculaneum, and Vesuvius.' },
];

const CREDENTIALS = [
  'Every origin-city route on this site — Rome, Naples, and Sorrento/Amalfi — has been ridden in person on the actual Circumvesuviana line',
  'Booked and paid for tickets the same way a reader would — no press comps or complimentary access',
  "Cross-checks each operator's current inclusions and departure times before publishing a verdict",
        ...
        <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-10 px-6 py-10 sm:px-14 sm:py-14 lg:grid-cols-2 lg:gap-14">
          <div>
            ...
            <h1 className="mt-3 font-display text-[34px] font-bold leading-[1.1] tracking-tight text-ink sm:text-[42px]">
              An Independent Pompeii Guide, Written From Every Origin City
            </h1>
            <p className="mt-5 text-[17px] leading-relaxed text-ink-muted">
              Most Pompeii guides are written from one base city and reused for every reader. This one isn&rsquo;t.
              Every route on this site — from Rome, from Naples, from Sorrento and the Amalfi Coast — was actually
              ridden on the Circumvesuviana line, cross-checked across every major operator, and published without a
            ...
            <p className="mt-4 rounded-panel border border-line bg-paper-tint p-4 text-sm leading-relaxed text-ink-muted">
              <strong className="text-ink">Pompeii Day Trip is independent and has no affiliation with the Parco
              Archeologico di Pompei</strong> or any other official body managing the archaeological sites it
              covers. Nothing on this site should be read as an official statement from, or endorsement by, any of
              them.
            </p>
      ...
      <section className="border-b border-line py-14 sm:py-16">
        <div className="mx-auto max-w-[760px] px-6 sm:px-14">
          ...
          <div className="mt-10 space-y-4 text-base leading-relaxed text-ink-muted">
            <p>
              Pompeii Day Trip exists because most Pompeii guides are written from a single base city — usually Rome
              — and reused regardless of where a reader is actually staying. Rome, Naples, and Sorrento/Amalfi each
              have genuinely different transit logistics to Pompeii, and treating them as interchangeable is where
              most generic guides go wrong. Every route, timing note, and comparison on this site comes from taking
              that specific trip in person, not from repeating marketing copy.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto mt-10 max-w-[1200px] px-6 sm:px-14">
          ...
          <div className="mt-4">
            <PhotoGallery images={POMPEII_GALLERY} />
          </div>
        </div>
        ...
        <div className="mx-auto mt-10 max-w-[760px] px-6 sm:px-14">
          <div className="space-y-4 text-base leading-relaxed text-ink-muted">
            <p>
              This site is independent. We are not owned by, affiliated with, or paid preferentially by the Parco
              Archeologico di Pompei, any single tour operator, or any ticketing platform — we link to whichever
              option is genuinely the best fit for a given origin city and situation, and we say plainly when a
              private guide or a combo tour isn&rsquo;t worth the extra cost.
            </p>
            <p>
      ...
      <section id="start-here" className="scroll-mt-[65px] border-b border-line bg-paper-tint py-14 sm:py-16">
        <div className="mx-auto max-w-[1200px] px-6 sm:px-14">
          ...
          <p className="mt-3 max-w-[62ch] text-base leading-relaxed text-ink-muted">
            Every guide below is its own independent comparison — pick the one that matches where you&rsquo;re
            actually staying.
          </p>
          ...
          <div className="flex flex-col items-start gap-6 rounded-media border border-line bg-paper-tint p-6 sm:flex-row sm:items-center sm:justify-between sm:p-8">
            <div>
              ...
              <p className="mt-2 max-w-[52ch] text-sm leading-relaxed text-ink-muted">
                The full comparison table — GetYourGuide, Viator, and Civitatis, ranked by price, duration, and
                whether genuine skip-the-line entry is actually included.
              </p>
            </div>
            <Link
              href="/#featured-tours"
