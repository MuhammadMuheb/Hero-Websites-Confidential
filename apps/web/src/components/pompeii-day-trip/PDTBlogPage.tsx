...
/**
 * Pompeii Day Trip Blog index page — redirects to the shared blog at /blog.
 * In production, this could be customized to show Pompeii-specific blog posts.
 * For now, uses NetworkLink to navigate while maintaining property context.
 */

export function PDTBlogPage() {
  return (
      ...
      <section className="py-14">
        <div className="mx-auto max-w-[1200px] px-6 sm:px-14 text-center">
          <p className="text-ink-muted">
            Blog articles about Pompeii, travel planning, and archaeological sites are coming soon.
          </p>
          <Link
            href="/blog"
