...
/**
 * Contact page — mirrors Underground Colosseum's UCContactPage.tsx structure
 ...
 * a restyled affiliate-disclosure card. This property adds the same
 * non-affiliation restatement as PVAboutPage, since the header banner and
 * footer line alone don't fully cover the blueprint's mandatory-disclosure
 * requirement (§4 rule 7) on a page as trust-sensitive as Contact.
 */
...
const CONTACT_CHANNELS = [
  ...
  },
  {
    ...
    detail: 'Wrong price, changed entry time, or a broken link — flag it and we fix it fast.',
    icon: (
      <>
...
function mailtoWithSubject(subject: string) {
  return `mailto:hello@privatevatican.com?subject=${encodeURIComponent(subject)}`;
}
    ...
    <div className="pv-scope bg-white">
      ...
      <section className="border-b border-line">
        ...
        <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-10 px-6 py-10 sm:px-14 sm:py-14 lg:grid-cols-2 lg:gap-14">
          <div>
            ...
            <a
              href="mailto:hello@privatevatican.com"
      ...
      <section className="border-b border-line py-14 sm:py-16">
        <div className="mx-auto max-w-[760px] px-6 sm:px-14">
          ...
          <h2 className="mt-2 font-display text-[26px] font-bold leading-snug tracking-tight text-ink sm:text-[32px]">
            Not Affiliated with the Vatican Museums
          </h2>
          <p className="mt-4 text-base leading-relaxed text-ink-muted">
            Private Vatican is an independent publication. We have no affiliation with, and are not endorsed or
            sponsored by, the Vatican Museums, the Governorate of Vatican City State, the Holy See, or any other
            official Vatican body. Every comparison and recommendation on this site reflects our own first-hand
            research, not an official position of any of those organizations.
          </p>
        </div>
      </section>
      ...
      <section id="disclosure" className="scroll-mt-[85px] border-b border-line py-14 sm:py-16">
        <div className="mx-auto max-w-[760px] px-6 sm:px-14">
          ...
          <div className="mt-8 rounded-media border border-line bg-paper-tint p-6 sm:p-8">
            ...
            <p className="mt-4 text-base leading-relaxed text-ink-muted">
              Private Vatican participates in affiliate programs with the three partners above. When you book a tour
          ...
          <div className="flex flex-col items-start gap-6 rounded-media border border-line bg-paper-tint p-6 sm:flex-row sm:items-center sm:justify-between sm:p-8">
            <div>
              ...
              <p className="mt-2 max-w-[52ch] text-sm leading-relaxed text-ink-muted">
                Read the full independence story, or jump straight into the flagship comparison of every early-access
                operator.
              </p>
            </div>
