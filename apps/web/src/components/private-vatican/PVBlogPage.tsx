    ...
    <div className="pv-scope bg-white">
      <section className="border-b border-line">
        ...
        <div className="mx-auto max-w-[1440px] px-6 py-14 text-center sm:px-14 sm:py-16">
          <h1 className="font-display text-3xl font-semibold text-ink sm:text-4xl">Private Vatican Blog</h1>
          <p className="mt-4 text-ink-muted">Travel tips, Vatican guides, and planning advice</p>
        </div>
      </section>
      ...
      <section className="py-14">
        <div className="mx-auto max-w-[1200px] px-6 sm:px-14 text-center">
          <p className="text-ink-muted">
            Blog articles about the Vatican, Sistine Chapel, and Vatican travel planning are coming soon.
          </p>
          <Link
            href="/blog"
