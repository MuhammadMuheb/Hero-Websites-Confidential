...
/**
 * Homepage for the Rome Pizza Class hero property (romepizzaclass.com,
 * served here at /rome-pizza-class). Mirrors GolfCartRomeHome.tsx's /
        ...
        <div className="flex flex-wrap items-end justify-between gap-y-4">
          <div>
            ...
            <h2 className="mt-2 font-sans text-[28px] font-extrabold leading-[1.15] tracking-tight text-ink sm:text-[36px]">
              Choose Your Rome Pizza-Making Class
            </h2>
          </div>
    ...
    <section id="featured-tours" className="scroll-mt-[65px] border-b border-line bg-paper-tint py-16 sm:py-20">
      <div className="mx-auto max-w-[1200px] px-6 sm:px-14">
        ...
        <p className="mt-2 flex items-center gap-1.5 text-sm font-semibold text-gold">
          ...
          Wood-fired and evening slots book out first — reserve at least a few days ahead in peak season.
        </p>
...
export function RomePizzaClassHome() {
  const websiteJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'WebSite',
    name: 'Rome Pizza Class',
    url: 'https://romepizzaclass.com/',
  };
  ...
  const itemListJsonLd = {
    ...
    itemListElement: MONEY_PAGES.map((page, index) => ({
      ...
      position: index + 1,
      name: page.title,
      url: `https://romepizzaclass.com${page.href}`,
    })),
  };
  ...
  const courseJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Course',
    name: 'Rome Pizza-Making Classes',
    description:
      'Independent guide to hands-on pizza-making classes in Rome — dough technique, wood-fired ovens, and family, private, and combo class options compared.',
      ...
      <section className="border-b border-line py-16 sm:py-20">
        <div className="mx-auto max-w-[1200px] px-6 sm:px-14">
          ...
          <p className="mt-3 max-w-[62ch] text-[15.5px] leading-relaxed text-ink-muted">
            ...
            oven is wood-fired or electric, and price.
          </p>
          <div className="mt-8">
            <TourComparisonTable tours={FEATURED_TOURS} caption="Comparison of every featured Rome Pizza Class listing by partner, duration, oven type and price" />
          </div>
        </div>
      </section>

      {/* ---------- before you book / support pages ---------- */}
      <section id="pizza-prep" className="scroll-mt-[65px] border-b border-line bg-paper-tint py-16 sm:py-20">
        <div className="mx-auto max-w-[1200px] px-6 sm:px-14">
