...
/**
 * Contact page — mirrors Rome Pizza Class's Contact page structure exactly:
 * a mailto contact method (no submission form — there's no backend to
 * receive one, so an honest mailto beats a form that silently goes
 * nowhere), a routed-by-topic contact grid, a response-time trust strip,
 * and a restyled affiliate-disclosure card.
 */
...
const CONTACT_CHANNELS = [
  {
    ...
    detail: 'Which class fits your group, tasting-format preference, or budget — ask before you book.',
    icon: (
      <>
  ...
  },
  {
    ...
    detail: 'Wrong price, changed tasting format, or a broken link — flag it and we fix it fast.',
    icon: (
      <>
  ...
  },
  {
    ...
    detail: 'Pastry schools, restaurants, and journalists — reach out here.',
    icon: (
      <>
...
function mailtoWithSubject(subject: string) {
  return `mailto:hello@tiramisuclass.com?subject=${encodeURIComponent(subject)}`;
}
    ...
    <div className="tc-scope bg-white">
      ...
      <section className="border-b border-line">
        ...
        <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-10 px-6 py-10 sm:px-14 sm:py-14 lg:grid-cols-2 lg:gap-14">
          <div>
            ...
            <a
              href="mailto:hello@tiramisuclass.com"
      ...
      <section className="border-b border-line py-14 sm:py-16">
        <div className="mx-auto max-w-[760px] px-6 sm:px-14">
          ...
          <h2 className="mt-2 font-display text-[24px] font-bold leading-snug tracking-tight text-ink sm:text-[30px]">
            Not Affiliated with Any Single Pastry School or Restaurant
          </h2>
          <p className="mt-4 text-base leading-relaxed text-ink-muted">
            Tiramisù Class is an independent publication. We have no affiliation with, and are not endorsed or
            sponsored by, any pastry school, restaurant, GetYourGuide, or Viator. Every comparison and recommendation
      ...
      <section id="disclosure" className="scroll-mt-[85px] border-b border-line py-14 sm:py-16">
        <div className="mx-auto max-w-[760px] px-6 sm:px-14">
          ...
          <div className="mt-8 rounded-media border border-line bg-paper-tint p-6 sm:p-8">
            ...
            <p className="mt-4 text-base leading-relaxed text-ink-muted">
              Tiramisù Class participates in affiliate programs with the two partners above. When you book a class
