...
/**
 * The site's About page — mirrors Rome Pizza Class's About page structure
 ...
 * site's independence from any single pastry school or restaurant here in
...
const TRUST_STATS = [
  { value: String(MONEY_PAGES.length), label: 'Class comparison guides', detail: 'One per booking decision — flagship, dessert-making, combo, and private.' },
  { value: String(GUIDE_COUNT), label: 'Before-you-book guides', detail: 'Inclusions, couples framing, gifting, and food-tour pairing notes.' },
...
const CREDENTIALS = [
  'Every class this site compares has been taken in person — mascarpone-folding technique and coffee-soak timing checked directly, not from marketing photos',
  'Trained as a pastry chef in Rome, with hands-on experience teaching no-bake dessert technique to complete beginners',
  "Cross-checks each operator's tasting format (chilled sample in class vs. take-home only) and group-size cap before publishing a verdict",
        ...
        <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-10 px-6 py-10 sm:px-14 sm:py-14 lg:grid-cols-2 lg:gap-14">
          <div>
            ...
            <h1 className="mt-3 font-display text-[30px] font-bold leading-[1.15] tracking-tight text-ink sm:text-[38px]">
              An Independent Rome Tiramisù Class Guide, Written by a Working Pastry Chef
            </h1>
            <p className="mt-5 text-[17px] leading-relaxed text-ink-muted">
              Most guides to tiramisù classes in Rome are written by whoever sells the ticket. This one isn&rsquo;t.
              Every comparison on this site starts from the same question &mdash; does this class actually teach
              real mascarpone technique and honest coffee-soak timing &mdash; cross-checked across every major
            ...
            <p className="mt-4 rounded-panel border border-line bg-paper-tint p-4 text-sm leading-relaxed text-ink-muted">
              <strong className="text-ink">Tiramisù Class is independent and has no affiliation with any single
              pastry school, restaurant, GetYourGuide, or Viator.</strong> Nothing on this site should be read as an
      ...
      <section className="border-b border-line py-14 sm:py-16">
        <div className="mx-auto max-w-[760px] px-6 sm:px-14">
          ...
          <div className="mt-10 space-y-4 text-base leading-relaxed text-ink-muted">
            <p>
              Tiramisù Class exists because most guides to dessert classes are written by whoever sells the ticket,
              not by someone who actually checks whether a given class teaches real mascarpone-folding technique and
              honest coffee-soak timing, or is mostly a plating-for-photos session dressed up in cocoa-dusting
              marketing shots. Every comparison, technique note, and practical tip on this site comes from checking
              what different operators (GetYourGuide, Viator) actually provide against each other, rather than
        ...
        <div className="mx-auto mt-10 max-w-[1200px] px-6 sm:px-14">
          <p className="text-xs font-semibold uppercase tracking-wide text-faint">
            Checked layer by layer, dip by dip &mdash; no stock substitutes for the actual class
          </p>
          <div className="mt-4">
            <PhotoGallery images={TIRAMISU_CLASS_GALLERY} />
          </div>
        </div>
        ...
        <div className="mx-auto mt-10 max-w-[760px] px-6 sm:px-14">
          <div className="space-y-4 text-base leading-relaxed text-ink-muted">
            <p>
              ...
              pastry school, restaurant, GetYourGuide, or Viator &mdash; we link to whichever class is genuinely the
          ...
          <div className="flex flex-col items-start gap-6 rounded-media border border-line bg-paper-tint p-6 sm:flex-row sm:items-center sm:justify-between sm:p-8">
            <div>
              ...
              <p className="mt-2 max-w-[52ch] text-sm leading-relaxed text-ink-muted">
                The full comparison table &mdash; GetYourGuide and Viator, ranked by price, duration, and tasting
                format.
              </p>
            </div>
            <Link
