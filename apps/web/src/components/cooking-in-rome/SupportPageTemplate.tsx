...
/**
 * Shared template for all 5 Cooking in Rome support pages — mirrors Golf
 * Cart Rome's/Rome Vespa's SupportPageTemplate.tsx exactly in structure
 ...
 * data-driven (lib/cooking-in-rome-content.ts).
 */
