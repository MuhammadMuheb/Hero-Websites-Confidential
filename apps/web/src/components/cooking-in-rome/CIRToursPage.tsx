...
import { FEATURED_TOURS } from '@/lib/cooking-in-rome';

export function CIRToursPage() {
  const jsonLd = {
    '@context': 'https://schema.org',
    '@type': 'CollectionPage',
    name: 'Cooking in Rome Classes',
    description: 'Featured cooking classes in Rome',
    url: 'https://cookinginrome.com/tours',
    mainEntity: {
      '@type': 'ItemList',
    ...
    <div className="cir-scope bg-white">
      ...
      <section className="border-b border-line">
        ...
        <div className="mx-auto max-w-[1440px] px-6 py-14 text-center sm:px-14 sm:py-16">
          <h1 className="font-display text-3xl font-semibold text-ink sm:text-4xl">Cooking Classes in Rome</h1>
          <p className="mt-4 text-ink-muted">Hands-on cooking, pasta-making, and market-to-table experiences</p>
        </div>
      </section>
