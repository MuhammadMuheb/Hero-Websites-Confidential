...
/**
 * Contact page — mirrors Golf Cart Rome's/Rome Vespa's Contact page
...
const CONTACT_CHANNELS = [
  {
    ...
    detail: 'Which class fits your dietary needs, group size, or budget — ask before you book.',
    icon: (
      <>
  ...
  },
  {
    ...
    detail: 'Wrong price, changed dietary policy, or a broken link — flag it and we fix it fast.',
    icon: (
      <>
  ...
  },
  {
    ...
    detail: 'Cooking schools, culinary organizations, and journalists — reach out here.',
    icon: (
      <>
...
function mailtoWithSubject(subject: string) {
  return `mailto:hello@cookinginrome.com?subject=${encodeURIComponent(subject)}`;
}
    ...
    <div className="cir-scope bg-white">
        ...
        <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-10 px-6 py-10 sm:px-14 sm:py-14 lg:grid-cols-2 lg:gap-14">
          <div>
            ...
            <p className="mt-5 max-w-[52ch] text-[16px] leading-relaxed text-ink-muted">
              Spotted something out of date, unsure which class fits your dietary needs, or have a partnership
              question? Email us directly &mdash; there&rsquo;s no ticket queue and no auto-reply between you and an
              answer.
            </p>

            <a
              href="mailto:hello@cookinginrome.com"
      ...
      <section className="border-b border-line py-14 sm:py-16">
        <div className="mx-auto max-w-[760px] px-6 sm:px-14">
          ...
          <h2 className="mt-2 font-sans text-[26px] font-extrabold leading-snug tracking-tight text-ink sm:text-[32px]">
            Not Affiliated with Any Single Cooking School
          </h2>
          <p className="mt-4 text-base leading-relaxed text-ink-muted">
            Cooking in Rome is an independent publication. We have no affiliation with, and are not endorsed or
            sponsored by, any cooking school, chef, or vehicle of the classes we compare. Every comparison and
      ...
      <section id="disclosure" className="scroll-mt-[85px] border-b border-line py-14 sm:py-16">
        <div className="mx-auto max-w-[760px] px-6 sm:px-14">
          ...
          <div className="mt-8 rounded-media border border-line bg-paper-tint p-6 sm:p-8">
            ...
            <p className="mt-4 text-base leading-relaxed text-ink-muted">
              Cooking in Rome participates in affiliate programs with the three partners above. When you book a
              class through an outbound link on this site, we may earn a commission at no extra cost to you. This
              site independently compares classes across all three platforms and does not accept payment for
              placement &mdash; a class appearing higher on a comparison reflects our own editorial judgment, not a
