...
export function UCToursPage() {
  const jsonLd = {
    '@context': 'https://schema.org',
    '@type': 'CollectionPage',
    name: 'Underground Colosseum Tours',
    description: 'Featured underground and arena-floor Colosseum tours',
    url: 'https://undergroundcolosseum.com/tours',
    mainEntity: {
      '@type': 'ItemList',
    ...
    <div className="uc-scope bg-white">
      ...
      <section className="border-b border-line">
        ...
        <div className="mx-auto max-w-[1440px] px-6 py-14 text-center sm:px-14 sm:py-16">
          <h1 className="font-display text-3xl font-semibold text-ink sm:text-4xl">Featured Underground & Arena Tours</h1>
          <p className="mt-4 text-ink-muted">Colosseum underground and arena-floor access options compared</p>
        </div>
      </section>
