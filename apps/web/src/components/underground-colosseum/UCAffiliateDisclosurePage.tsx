...
import { AFFILIATE_DISCLOSURE } from '@/lib/underground-colosseum';

export function UCAffiliateDisclosurePage() {
  return (
        ...
        <div className="mx-auto max-w-[720px] px-6 sm:px-14 space-y-8">
          ...
          <div className="pt-6 border-t border-line">
            <p className="text-xs text-faint">
              Questions? Email us at <a href={`mailto:${AFFILIATE_DISCLOSURE.contactEmail}`} className="text-accent hover:text-accent-hover">{AFFILIATE_DISCLOSURE.contactEmail}</a>
            </p>
          </div>
        </div>
      </section>
