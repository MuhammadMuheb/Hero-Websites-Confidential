...
import { FEATURED_TOURS } from '@/lib/rome-vespa';

export function RVToursPage() {
  const jsonLd = {
    '@context': 'https://schema.org',
    '@type': 'CollectionPage',
    name: 'Rome Vespa Tours',
    description: 'Featured Vespa and sidecar tours in Rome — guided, self-drive, and sunset options',
    url: 'https://romevespa.com/tours',
    mainEntity: {
      '@type': 'ItemList',
    ...
    <div className="rv-scope bg-white">
      ...
      <section className="border-b border-line">
        ...
        <div className="mx-auto max-w-[1440px] px-6 py-14 text-center sm:px-14 sm:py-16">
          <h1 className="font-display text-3xl font-semibold text-ink sm:text-4xl">Featured Vespa Tours</h1>
          <p className="mt-4 text-ink-muted">Guided, self-drive, sidecar, and private options in Rome</p>
        </div>
      </section>
