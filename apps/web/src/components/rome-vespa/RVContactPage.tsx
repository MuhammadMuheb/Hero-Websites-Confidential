...
import { RVFooter, RVHeader } from './RVShared';
import { HERO_IMAGE } from '@/lib/rome-vespa';

/**
 * Contact page — mirrors Private Vatican's/Underground Colosseum's Contact
 * page structure exactly: a mailto contact method (no submission form —
 * there's no backend to receive one, so an honest mailto beats a form that
 * silently goes nowhere), a routed-by-topic contact grid, a response-time
 * trust strip, and a restyled affiliate-disclosure card.
 */
...
const CONTACT_CHANNELS = [
  {
    ...
    detail: 'Which tour fits your riding experience, group size, or budget — ask before you book.',
    icon: (
      <>
  ...
  },
  {
    ...
    detail: 'Wrong price, changed licence rule, or a broken link — flag it and we fix it fast.',
    icon: (
      <>
  ...
  },
  {
    ...
    detail: 'Tour operators, rental agencies, and journalists — reach out here.',
    icon: (
      <>
...
function mailtoWithSubject(subject: string) {
  return `mailto:hello@romevespa.com?subject=${encodeURIComponent(subject)}`;
}

export function RVContactPage() {
  return (
    <div className="rv-scope bg-white">
      ...
      <section className="border-b border-line">
        ...
        <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-10 px-6 py-10 sm:px-14 sm:py-14 lg:grid-cols-2 lg:gap-14">
          <div>
            ...
            <a
              href="mailto:hello@romevespa.com"
      ...
      <section className="border-b border-line py-14 sm:py-16">
        <div className="mx-auto max-w-[760px] px-6 sm:px-14">
          ...
          <h2 className="mt-2 font-sans text-[26px] font-extrabold leading-snug tracking-tight text-ink sm:text-[32px]">
            Not Affiliated with Piaggio or Any Vespa Dealer
          </h2>
          <p className="mt-4 text-base leading-relaxed text-ink-muted">
            Rome Scooter Tours is an independent publication. We have no affiliation with, and are not endorsed or
            sponsored by, Piaggio, any Vespa dealership, or any rental or tour operator. Every comparison and
            recommendation on this site reflects our own first-hand riding and research, not an official position of
      ...
      <section id="disclosure" className="scroll-mt-[85px] border-b border-line py-14 sm:py-16">
        <div className="mx-auto max-w-[760px] px-6 sm:px-14">
          ...
          <div className="mt-8 rounded-media border border-line bg-paper-tint p-6 sm:p-8">
            ...
            <p className="mt-4 text-base leading-relaxed text-ink-muted">
              Rome Scooter Tours participates in affiliate programs with the two partners above. When you book a tour
              through an outbound link on this site, we may earn a commission at no extra cost to you. This site
              independently compares tours across both platforms and does not accept payment for placement — a tour
              appearing higher on a comparison reflects our own editorial judgment, not a sponsorship arrangement.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col items-start gap-6 rounded-media border border-line bg-paper-tint p-6 sm:flex-row sm:items-center sm:justify-between sm:p-8">
            <div>
              ...
              <p className="mt-2 max-w-[52ch] text-sm leading-relaxed text-ink-muted">
                Read the full independence story, or jump straight into the flagship comparison of every guided
                operator.
              </p>
            </div>
