...
/**
 * Shared template for all 5 Rome Vespa support pages — mirrors Private
 * Vatican's/Underground Colosseum's SupportPageTemplate.tsx exactly in
 * structure (FAQPage + BreadcrumbList schema, first-hand detail, one primary
 * CTA into the money page it feeds, one contextual link, FAQ). Content is
 * entirely data-driven (lib/rome-vespa-content.ts).
 */
