...
export function PompeiiDayTripHome() {
  ...
  return (
    <div className="pdt-scope bg-white">
        ...
        <div className="mx-auto grid max-w-[1200px] gap-10 px-6 py-14 sm:px-14 lg:grid-cols-[1.05fr_1fr] lg:items-center lg:py-20">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.14em] text-faint">
              Pompeii day trips, multi-origin
            </p>
            <h1 className="mt-4 font-display text-[38px] font-bold leading-[1.08] tracking-tight text-ink sm:text-[54px]">
              Pompeii Day Trips, Planned From Wherever You&rsquo;re Actually Staying
            </h1>
            <p className="mt-5 max-w-[52ch] text-[17px] leading-relaxed text-ink-muted">
              Rome, Naples, Sorrento, or the Amalfi Coast — the right way to do Pompeii changes depending on your
              base. Written by a guide who has run this day trip from every one of them.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-2.5 text-sm text-ink-muted sm:flex-row sm:flex-wrap sm:gap-x-6 sm:gap-y-2">
              {[
                'First-hand from every origin city',
                'Train-vs-tour logistics, honestly compared',
                'No invented visitor stats — only verifiable site facts',
                'Independent, not affiliated with the Parco Archeologico di Pompei',
              ].map((label) => (
      ...
      <div id="origin" className="scroll-mt-[65px] border-b border-line bg-white">
