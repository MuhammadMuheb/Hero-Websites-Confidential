    ...
    <div className="tdt-scope bg-white">
      <section className="border-b border-line">
        ...
        <div className="mx-auto max-w-[1440px] px-6 py-14 text-center sm:px-14 sm:py-16">
          <h1 className="font-display text-3xl font-semibold text-ink sm:text-4xl">Tuscany Day Trip Blog</h1>
          <p className="mt-4 text-ink-muted">Travel tips, wine guides, and planning advice for Tuscany</p>
        </div>
      </section>
      ...
      <section className="py-14">
        <div className="mx-auto max-w-[1200px] px-6 sm:px-14 text-center">
          <p className="text-ink-muted">
            Blog articles about Tuscany, wine tours, hill towns, and day-trip planning are coming soon.
          </p>
          <Link
            href="/blog"
