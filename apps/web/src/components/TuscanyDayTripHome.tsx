...
/**
 * Homepage for the Tuscany Day Trip hero property (tuscanydaytrip.com,
    ...
    <section id="featured-tours" className="scroll-mt-[65px] border-b border-line bg-paper-tint py-16 sm:py-20">
      <div className="mx-auto max-w-[1200px] px-6 sm:px-14">
        ...
        <p className="mt-2 flex items-center gap-1.5 text-sm font-semibold text-gold">
          ...
          Private and wine-tasting slots book out first — reserve at least a few days ahead in peak season.
        </p>
...
export function TuscanyDayTripHome() {
  const websiteJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'WebSite',
    name: 'Tuscany Day Trip',
    url: 'https://tuscanydaytrip.com/',
  };
  ...
  const itemListJsonLd = {
    ...
    itemListElement: MONEY_PAGES.map((page, index) => ({
      ...
      position: index + 1,
      name: page.title,
      url: `https://tuscanydaytrip.com${page.href}`,
    })),
  };
  ...
  const touristTripJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'TouristTrip',
    name: 'Tuscany Day Trips from Florence',
    description:
      'Independent guide to Tuscany day trips from Florence — Chianti wine tasting, Siena, San Gimignano, and honest drive-vs-tour logistics compared.',
    ...
    <div className="tdt-scope bg-white">
        ...
        <div className="mx-auto grid max-w-[1200px] gap-10 px-6 py-14 sm:px-14 lg:grid-cols-[1.05fr_1fr] lg:items-center lg:py-20">
          <div>
            ...
            <h1 className="mt-4 font-display text-[34px] font-bold leading-[1.12] tracking-tight text-ink sm:text-[48px]">
              Tuscany Day Trips, Chosen for What You Actually Want From the Day
            </h1>
            <p className="mt-5 max-w-[52ch] text-[17px] leading-relaxed text-ink-muted">
              Wine tasting, hill towns, or both &mdash; every route here has been driven and walked in person, with
              honest notes on when a car beats a tour and when it doesn&rsquo;t.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-2.5 text-sm text-ink-muted sm:flex-row sm:flex-wrap sm:gap-x-6 sm:gap-y-2">
              {[
                'Every route driven and walked first-hand',
                'Honest wine-tour logistics, not brochure copy',
                'Best season guidance, not just "anytime is great"',
                'Independent — no vineyard or tour operator ownership',
              ].map((label) => (
      ...
      <section className="border-b border-line bg-paper-tint py-14 sm:py-16">
        <div className="mx-auto max-w-[1200px] px-6 sm:px-14">
          ...
          <p className="mt-3 max-w-[62ch] text-[15.5px] leading-relaxed text-ink-muted">
            A little history and geography before you book — the region and the logistics behind every day trip.
          </p>
          <div className="mt-8">
      ...
      <section className="border-b border-line py-16 sm:py-20">
        <div className="mx-auto max-w-[1200px] px-6 sm:px-14">
          ...
          <h2 className="mt-2 font-display text-[26px] font-bold leading-[1.2] tracking-tight text-ink sm:text-[32px]">
            Compare All 8 Day Trips at a Glance
          </h2>
          <p className="mt-3 max-w-[62ch] text-[15.5px] leading-relaxed text-ink-muted">
            The same 8 listings as the carousel above, laid out as a straight spec comparison — duration, whether
            wine tasting is actually included, and price.
          </p>
          <div className="mt-8">
            <TourComparisonTable tours={FEATURED_TOURS} caption="Comparison of every featured Tuscany Day Trip listing by partner, duration, wine-tasting inclusion and price" />
          </div>
        </div>
      </section>
