...
import {
  ...
  RVHeader,
  useCardCarousel,
} from '@/components/rome-vespa/RVShared';

/**
 * Homepage for the Rome Vespa hero property (romevespa.com, served here at
 * /rome-vespa). Mirrors PrivateVaticanHome.tsx's / PompeiiDayTripHome.tsx's
 * structure exactly: hero -> quick-jump chips -> facts strip -> 5 money-page
 * cards -> featured tours -> full comparison table -> ride-prep support-page
 ...
 * RVHeader/RVFooter (see components/rome-vespa/RVShared.tsx), wrapped in
 * `.rv-scope` (see globals.css) so this property's Riviera Teal accent never
 * leaks onto any sibling property.
 */
    ...
    <section id="featured-tours" className="scroll-mt-[65px] border-b border-line bg-paper-tint py-16 sm:py-20">
      <div className="mx-auto max-w-[1200px] px-6 sm:px-14">
        ...
        <p className="mt-2 flex items-center gap-1.5 text-sm font-semibold text-gold">
          ...
          Sunset and sidecar slots book out first — reserve at least 2–3 weeks ahead in peak season.
        </p>
...
export function RomeVespaHome() {
  const websiteJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'WebSite',
    name: 'Rome Scooter Tours',
    url: 'https://romevespa.com/',
  };
  ...
  const itemListJsonLd = {
    ...
    itemListElement: MONEY_PAGES.map((page, index) => ({
      ...
      position: index + 1,
      name: page.title,
      url: `https://romevespa.com${page.href}`,
    })),
  };
  ...
  const touristTripJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'TouristTrip',
    name: 'Rome Vespa & Sidecar Tours',
    description:
      'Independent guide to Vespa and sidecar tours in Rome — real routes, honest licence requirements, and which option actually suits you.',
    url: 'https://romevespa.com/',
  };
  ...
  return (
    <div className="rv-scope bg-white">
        ...
        <div className="mx-auto grid max-w-[1200px] gap-10 px-6 py-14 sm:px-14 lg:grid-cols-[1.05fr_1fr] lg:items-center lg:py-20">
          <div>
            ...
            <h1 className="mt-4 font-sans text-[38px] font-extrabold leading-[1.08] tracking-tight text-ink sm:text-[54px]">
              See Rome the Way It&rsquo;s Actually Meant to Be Seen &mdash; From a Scooter
            </h1>
            <p className="mt-5 max-w-[52ch] text-[17px] leading-relaxed text-ink-muted">
              Guided or self-drive, sidecar or solo &mdash; every route on this site has been ridden in real Rome
              traffic, not plotted on a map from a desk.
            </p>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              ...
              >
                Is it actually safe in traffic?
              </Link>
            </div>

            <div className="mt-8 flex flex-col gap-2.5 text-sm text-ink-muted sm:flex-row sm:flex-wrap sm:gap-x-6 sm:gap-y-2">
              {[
                'Every route ridden in person, not mapped remotely',
                'Licence requirements explained plainly, no fine print',
                'Sidecar option for anyone who’d rather not drive',
                'Independent — not affiliated with Piaggio or any Vespa dealer',
              ].map((label) => (
      ...
      <section className="border-b border-line bg-paper-tint py-14 sm:py-16">
        <div className="mx-auto max-w-[1200px] px-6 sm:px-14">
          ...
          <h2 className="mt-2 font-sans text-[26px] font-extrabold leading-snug tracking-tight text-ink sm:text-[32px]">
            The Vespa, by the Numbers
          </h2>
          <p className="mt-3 max-w-[62ch] text-[15.5px] leading-relaxed text-ink-muted">
            A little history before you book — the scooter these tours actually ride.
          </p>
          <div className="mt-8">
      ...
      <section className="border-b border-line py-16 sm:py-20">
        <div className="mx-auto max-w-[1200px] px-6 sm:px-14">
          ...
          <p className="mt-3 max-w-[62ch] text-[15.5px] leading-relaxed text-ink-muted">
            ...
            tour is a licence-free sidecar format, and price.
          </p>
          <div className="mt-8">
            <TourComparisonTable tours={FEATURED_TOURS} caption="Comparison of every featured Rome Vespa tour by partner, duration, sidecar format and price" />
          </div>
        </div>
      </section>
      ...
      <section id="ride-prep" className="scroll-mt-[65px] border-b border-line bg-paper-tint py-16 sm:py-20">
        <div className="mx-auto max-w-[1200px] px-6 sm:px-14">
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-accent">Free ride-prep guides</p>
          <h2 className="mt-2 font-sans text-[28px] font-extrabold leading-[1.15] tracking-tight text-ink sm:text-[36px]">
            Get Ready to Ride
          </h2>
          <p className="mt-3 max-w-[62ch] text-[15.5px] leading-relaxed text-ink-muted">
