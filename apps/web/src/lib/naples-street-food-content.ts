...
export function getMoneyPageContent(href: string): MoneyPageContent | null {
  const pages: Record<string, MoneyPageContent> = {
    ...
    "/spaccanapoli-food-walk": {
      ...
      heroImage: { src: 'https://images.unsplash.com/photo-1640307112649-01bfc4c77a77', alt: "A narrow cobblestone street in an Italian historic centre" },
...
export function getSupportPageContent(href: string): SupportPageContent | null {
  const pages: Record<string, SupportPageContent> = {
    ...
    "/where-locals-eat": {
      ...
      heroImage: { src: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd', alt: 'Bustling neighborhood trattoria filled with locals eating at communal tables' },
