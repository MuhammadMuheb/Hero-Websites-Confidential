...
const MONEY_PAGE_RELEVANCE: Record<string, string[]> = {
  '/early-entry-vatican-sistine': ['early-access', 'sistine'],
  '/private-vatican-guide': ['private', 'early-access'],
  '/vatican-st-peter-s-dome': ['dome', 'combo'],
  '/vatican-with-kids-family': ['family'],
  '/skip-the-line-explained': ['skip-the-line', 'self-paced', 'budget'],
};
...
export const QUICK_LINKS = [
  { label: 'Early-Entry & Sistine', href: '/early-entry-vatican-sistine' },
  { label: 'Private Guide', href: '/private-vatican-guide' },
  { label: "St Peter's Dome", href: '/vatican-st-peter-s-dome' },
  { label: 'With Kids', href: '/vatican-with-kids-family' },
  { label: 'Skip the Line', href: '/skip-the-line-explained' },
  { label: 'Dress Code & Security', href: '/dress-code-security' },
  { label: 'Quietest Times', href: '/quietest-times-to-visit' },
];
