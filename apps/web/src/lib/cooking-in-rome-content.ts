...
export const MONEY_PAGE_CONTENT: MoneyPageContent[] = [
  {
    ...
    relatedSupportHref: '/what-a-class-includes',
  ...
  },
  {
    ...
    relatedSupportHref: '/vegetarian-options',
  ...
  },
  {
    ...
    relatedSupportHref: '/classes-with-a-market-visit',
  ...
  },
  {
    ...
    relatedSupportHref: '/gift-a-cooking-class',
...
export const SUPPORT_PAGE_CONTENT: SupportPageContent[] = [
  {
    ...
    relatedMoneyHref: '/best-rome-cooking-classes',
  ...
  },
  {
    ...
    relatedMoneyHref: '/market-to-table-class',
  ...
  },
  {
    ...
    relatedMoneyHref: '/pasta-making-class',
  ...
  },
  {
    ...
    relatedMoneyHref: '/private-small-group-class',
