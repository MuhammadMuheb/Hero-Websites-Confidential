...
export const FEATURED_TOURS: FeaturedTour[] = [
  ...
  },
  {
    ...
    image: { src: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4', alt: 'Naples market vendor slicing fresh mozzarella with a wire while customer watches' },
  },
];
...
export const SUPPORT_PAGES = [
  ...
  },
  {
    ...
    image: { src: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd', alt: 'Bustling neighborhood trattoria filled with locals eating at communal tables' },
  },
];
...
export const PRIVACY_POLICY = {
  ...
  contactEmail: 'hello@naples-street-food.com',
};
